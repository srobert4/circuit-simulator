...
QT_MOC_LITERAL(1, 16, 11), // "clickedAway"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 12) // "slotDeselect"

    },
    "ElementSelector\0clickedAway\0\0slotDeselect"
};
...
void ElementSelector::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->clickedAway(); break;
        case 1: _t->slotDeselect(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ElementSelector::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ElementSelector::clickedAway)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ElementSelector::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ElementSelector.data,
      qt_meta_data_ElementSelector,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void ElementSelector::clickedAway()
{
