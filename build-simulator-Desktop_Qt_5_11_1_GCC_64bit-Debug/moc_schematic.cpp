...
void Schematic::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Schematic::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Schematic::schematicClicked)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Schematic::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Schematic.data,
      qt_meta_data_Schematic,  qt_static_metacall, nullptr, nullptr}
};
